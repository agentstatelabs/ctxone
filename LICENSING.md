...
CTXone is open source, licensed under the **Business Source License 1.1
(BSL 1.1)**. See [LICENSE](LICENSE) for the authoritative license text. This
document is a plain-English summary of what that license means.

CTXone is one half of a suite. It is the shared memory layer for
**[AgentStateDeveloper](https://github.com/agentstatelabs/AgentStateDeveloper)**
(per-developer code context) — see the READMEs for how they pair.
...
If you're unsure whether your use case is covered by the BSL 1.1 grant, email
